...
alias ark="$HOME/core-aaa/packages/core/bin/run"
echo 'alias aaa="$HOME/core-aaa/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-aaa"
git clone "https://github.com/sero2one/bts500aaa-core.git" "$HOME/core-aaa" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/sero2one/bts500aaa-core.git'"
...
rm -rf "$HOME/.config/@aaa"
rm -rf "$HOME/.config/@aaa"
rm -rf "$HOME/.config/aaa-core"
